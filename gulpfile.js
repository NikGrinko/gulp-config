...
let path = {
    build: {
        ...
        fontAwesome: project_folder + "/css/fontAwesome/",
        webfonts: project_folder + "/css/webfonts/",
    ...
    src: {
        ...
        fontAwesome: source_folder + "/css/fontAwesome/*.css",
        webfonts: source_folder + "/css/webfonts/*.{eot,svg,ttf,woff,woff2}",
    },
    watch: {
...
let build = gulp.series(gulp.parallel(cssfontAwesome, fontAwesome), gulp.parallel(html, css, js, images, fonts), fontsStyle);
let watch = gulp.parallel(build, watchFiles, browserSync);



exports.cssfontAwesome = cssfontAwesome;
